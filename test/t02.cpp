...
~daemon() noexcept
{
  std::cout << "Destroy console ..." << std::endl;
}
...
void between()
{
  std::cout << "Call between() ..." << std::endl;
}
...
want to. Cheers!",
  ...
  cout << "Checking console app with no args" << endl;
  cout << "---------------------------------------------------------" << endl;
  try
  {
  ...
  cout << "Checking console app with command line args" << endl;
  cout << "---------------------------------------------------------" << endl;
